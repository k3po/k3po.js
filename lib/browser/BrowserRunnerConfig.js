...
BrowserRunnerConfig.prototype.build = function () {
    if (!this._browserRunner) {
        if (this._options == null) {
            ...
            this._browserRunner = new BrowserRunner(this._options, this._origin, this._resources, this._debug);
        }
    }
 ...
 * Enables debugging
 */
BrowserRunnerConfig.prototype.debug = function () {
    this._debug = true;
};

BrowserRunnerConfig.prototype.getSessionID = function() {
    return this._browserRunner.getSessionID();
};
