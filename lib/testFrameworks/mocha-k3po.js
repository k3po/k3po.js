    ...
    suite.on('pre-require', function (context, file, mocha) {
        ...
        suite.afterEach(function (done) {
            ...
            function recordTestResult(test){
                ...
                // testResults.push({name: test.title, result: _this.currentTest.state, titles: flattenTitles(test) });
                if (_this.currentTest.state === 'failed') {
                    failedTests++;
                }
            }

            recordTestResult(_this.currentTest);
        ...
        suite.afterAll(function (done) {
            ...
            // console.log("========no of failed tests");
